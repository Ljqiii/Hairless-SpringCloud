...
public interface CompetitionMapper {
    ...
    @Insert("insert into competition(title,createUsername,startTime,endTime,isPublic,description,encodedPassword,isDel)values (#{title},#{createUsername},#{startTime},#{endTime},#{isPublic},#{description},#{encodedPassword},#{isDel})")
